...
def test_select_cases_builds_qualitative_buckets() -> None:
    cpo_margins = [
        {"prompt_id": "p0", "normalized_margin": 0.9, "normalized_win": True},
        {"prompt_id": "p1", "normalized_margin": -0.4, "normalized_win": False},
        {"prompt_id": "p2", "normalized_margin": 0.2, "normalized_win": True},
    ]
    cpo_unary_margins = [
        {"prompt_id": "p0", "normalized_margin": 0.1, "normalized_win": True},
        {"prompt_id": "p1", "normalized_margin": 0.2, "normalized_win": True},
        {"prompt_id": "p2", "normalized_margin": -0.2, "normalized_win": False},
    ]
    ...
    assert cases["cpo_strong_wins"][0]["prompt_id"] == "p0"
    assert cases["cpo_strong_losses"][0]["prompt_id"] == "p1"
